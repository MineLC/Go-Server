...
func HandleState2(watcher util.Watcher, join chan base.PlayerAndConnection) {
	...
	watcher.SubAs(func(packet *server.PacketLoginInStart, conn base.Connection) {
	...
	watcher.SubAs(func(packet *server.PacketLoginInEncryptionBegin, conn base.Connection) {
		defer func() {
