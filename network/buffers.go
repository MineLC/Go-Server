...
import (
	...
	api_net "github.com/minelc/go-server-api/network"
)
...
func (b *buffer) PullUID() data.UUID {
	data, _ := data.BitsToUUID(b.PullI64(), b.PullI64())
...
func (b *buffer) PushUID(uuid data.UUID) {
	msb, lsb := data.SigBits(uuid)
